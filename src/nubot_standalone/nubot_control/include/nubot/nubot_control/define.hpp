...
const double          LIMITEDRPM  =  7200.0;    // the top limited rpm
...
const double    FIELDWIDTH = 1200.0;//the field width   1200cm
const double    CORNERSIZE = 200.0; // the corner size  200cm
//
const double    GOALWIDTH=200.0;    // the width of the goal

const double    OurPenltyAreaX=150*(FIELDLENGTH/1200.0);
const double    OurPenltyAreaY=150*(FIELDLENGTH/1200.0)+GOALWIDTH/2;
const double    OurGoalKeeperAreaX=50*(FIELDLENGTH/1200.0);
const double    OurGoalKeeperAreaY=50*(FIELDLENGTH/1200.0)+GOALWIDTH/2;
//
const double    OppPenaltyAreaX = 150*(FIELDLENGTH/1200.0);
const double    OppPenaltyAreaY = 150*(FIELDLENGTH/1200.0)+GOALWIDTH/2;

const double    OppGoalKeeperAreaX=50*(FIELDLENGTH/1200.0);
const double    OppGoalKeeperAreaY=50*(FIELDLENGTH/1200.0)+GOALWIDTH/2;

const double    OBSRECORDNUM = 10.0;
const double    LIMITEDBALLSPEED = 50.0;
