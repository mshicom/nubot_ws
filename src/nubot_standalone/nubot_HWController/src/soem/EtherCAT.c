...
#define  Delay2IGBT     50   //继电器导通到IGBT导通控制时间间隔,一次30ms,共210ms
#define  ShotFinishTime 500  //射门完成周期,一次30ms,共1s
int kicktime=0;
...
void Elmo_init()
{
	...
	*data_out++ = 0x0000000300606022;
	...
	/* MAX SPEED---50910=10000rpm*33 */
	data_out = (uint64 *)ec_slave[can_slave_num].outputs;
	*data_out++ = 0x0005091000607F22;
	*data_out++ = 0x0005091000607F22;
	*data_out++ = 0x0005091000607F22;
	*data_out++ = 0x0005091000607F22;
	*data_out++ = 0x0005091000607F22;
	...
	*data_out++ = 0x0005091000607F22;
	...
	/*MAX ACC---493E0=300000*/
	data_out = (uint64 *)ec_slave[can_slave_num].outputs;
	*data_out++ = 0x000493E000608322;
	*data_out++ = 0x000493E000608322;
	*data_out++ = 0x000493E000608322;
	*data_out++ = 0x000493E000608322;
	*data_out++ = 0x000493E000608322;
	...
	*data_out++ = 0x000493E000608322;
	...
	/*MAX DCC---493E0=300000*/
	data_out = (uint64 *)ec_slave[can_slave_num].outputs;
	*data_out++ = 0x000493E000608422;
	*data_out++ = 0x000493E000608422;
	*data_out++ = 0x000493E000608422;
	*data_out++ = 0x000493E000608422;
	*data_out++ = 0x000493E000608422;
...
{
    uint64 *data_out = (uint64 *)ec_slave[can_slave_num].outputs;
    /*EREASE ERROR*/
    data_out = (uint64 *)ec_slave[can_slave_num].outputs;
    *data_out++ = 0x0000008000604022;
    *data_out++ = 0x0000008000604022;
